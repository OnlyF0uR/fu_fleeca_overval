...
Config.timer = 180 -- countdown to secure lock in seconds (time needed to pass to door to be closed back)
Config.maxcash = 3500 -- maximum amount of cash a pile can hold
